...
const { timeKeyboard, day_offKeyboard, daysKeyboard, userKeyboardUz, userKeyboardRU, adminKeyboardUZ, adminKeyboardRu } = require("../menu/keyboard")
const { jobTime, Days, formatDate, DaysUz, DaysRu } = require("../../utils/time")
...
if(application) {
    await Application.findByIdAndUpdate(application._id,{...application , time : text})
...
<b>Telefon raqam:</b> ${e.user?.phone}
...
<b>Номер телефона:</b> ${e.user?.phone}
...
<b>Telefon raqam:</b> ${senderUser?.phone}
...
<b>Номер телефона:</b> ${senderUser?.phone}
